class Tourism {
  ...
  // 1. Berdasarkan response endpoint /list dari Tourism API, ada 2 jenis. Saat ini, kita akan mengonversi data jenis kedua terlebih dahulu karena kelas modelnya sudah tersedia.
